...
public class Ranking {
	...
	public static void updateranking(){
		...
		ss.setLine(0, "===========");
		ss.setLine(1, "Top 10");
		ss.setLine(2, "in Bedwars");
		ss.setLine(3, "===========");
		ss.update();
		
//		===================================================================================================================
		if(BedwarsStats.getPlayerWho(1) != null){
		String uuid = BedwarsStats.getPlayerWhoUUID(1);
		...
		int wins = BedwarsStats.getWins(uuid, spieler1);
		int kills = BedwarsStats.getKills(uuid.toString(), spieler1);
		int tode = BedwarsStats.getTode(uuid.toString(), spieler1);
		double kd = 0.0;
		if(tode == 0){
			kd = kills;
		}else{
...
//		===========================================================================================================
		if(BedwarsStats.getPlayerWho(2) != null){
			String uuid = BedwarsStats.getPlayerWhoUUID(2);
			String spieler1 = SpielerUUID.getSpielername(uuid);
		int wins2 = BedwarsStats.getWins(uuid, spieler1);
		int kills2 =BedwarsStats.getKills(uuid, spieler1);
		int tode2 = BedwarsStats.getTode(uuid, spieler1);
		double kd2 = 0.0;
		if(tode2 == 0){
			kd2 = kills2;
		}else{
...
//		===========================================================================================================
		if(BedwarsStats.getPlayerWho(3) != null){
			String uuid = BedwarsStats.getPlayerWhoUUID(3);
			String spieler1 = SpielerUUID.getSpielername(uuid);
		int wins3 = BedwarsStats.getWins(uuid, spieler1);
		int kills3 = BedwarsStats.getKills(uuid, spieler1);
		int tode3 = BedwarsStats.getTode(uuid, spieler1);
		double kd3 = 0.0;
		if(tode3 == 0){
			kd3 = kills3;
		}else{
...
//		===========================================================================================================
		if(BedwarsStats.getPlayerWho(4) != null){
			String uuid = BedwarsStats.getPlayerWhoUUID(4);
			String spieler1 = SpielerUUID.getSpielername(uuid);
		int wins4 = BedwarsStats.getWins(uuid, spieler1);
		int kills4 = BedwarsStats.getKills(uuid, spieler1);
		int tode4 = BedwarsStats.getTode(uuid, spieler1);
		double kd4 = 0.0;
		if(tode4 == 0){
			kd4 = kills4;
		}else{
...
//		===========================================================================================================
		if(BedwarsStats.getPlayerWho(5) != null){
			String uuid = BedwarsStats.getPlayerWhoUUID(5);
			String spieler1 = SpielerUUID.getSpielername(uuid);
		int wins4 = BedwarsStats.getWins(uuid, spieler1);
		int kills4 = BedwarsStats.getKills(uuid, spieler1);
		int tode4 = BedwarsStats.getTode(uuid, spieler1);
...
//		===========================================================================================================
		if(BedwarsStats.getPlayerWho(6) != null){
			String uuid = BedwarsStats.getPlayerWhoUUID(6);
			String spieler1 = SpielerUUID.getSpielername(uuid);
		int wins4 = BedwarsStats.getWins(uuid, spieler1);
		int kills4 = BedwarsStats.getKills(uuid, spieler1);
		int tode4 = BedwarsStats.getTode(uuid, spieler1);
...
//		===========================================================================================================
		if(BedwarsStats.getPlayerWho(7) != null){
			String uuid = BedwarsStats.getPlayerWhoUUID(7);
			String spieler1 = SpielerUUID.getSpielername(uuid);
		int wins4 = BedwarsStats.getWins(uuid, spieler1);
		int kills4 = BedwarsStats.getKills(uuid, spieler1);
		int tode4 = BedwarsStats.getTode(uuid, spieler1);
...
//		===========================================================================================================
		if(BedwarsStats.getPlayerWho(8) != null){
			String uuid = BedwarsStats.getPlayerWhoUUID(8);
			String spieler1 = SpielerUUID.getSpielername(uuid);
		int wins4 = BedwarsStats.getWins(uuid, spieler1);
		int kills4 = BedwarsStats.getKills(uuid, spieler1);
		int tode4 = BedwarsStats.getTode(uuid, spieler1);
...
//		===========================================================================================================
		if(BedwarsStats.getPlayerWho(9) != null){
			String uuid = BedwarsStats.getPlayerWhoUUID(9);
			String spieler1 = SpielerUUID.getSpielername(uuid);
		int wins4 = BedwarsStats.getWins(uuid, spieler1);
		int kills4 = BedwarsStats.getKills(uuid, spieler1);
		int tode4 = BedwarsStats.getTode(uuid, spieler1);
...
//	===========================================================================================================
	if(BedwarsStats.getPlayerWho(10) != null){
		String uuid = BedwarsStats.getPlayerWhoUUID(10);
		String spieler1 = SpielerUUID.getSpielername(uuid);
	int wins4 = BedwarsStats.getWins(uuid, spieler1);
	int kills4 = BedwarsStats.getKills(uuid, spieler1);
	int tode4 = BedwarsStats.getTode(uuid, spieler1);
